...
public class Carreras {
    ...
    public void setCodigo_facultad(String estatus_curso) {
    ...
    public Carreras(String codigo_carrera, String codigo_facultad, String nombre_carrera) {
        this.codigo_carrera = codigo_carrera;
        this.codigo_facultad = codigo_facultad;
        this.nombre_carrera = nombre_carrera;
    }
    ...
    public Carreras(String codigo_carrera, String codigo_facultad ,String nombre_carrera, String estatus_carrera) {
        this.codigo_carrera = codigo_carrera;
        this.codigo_facultad = codigo_facultad;
        this.nombre_carrera = nombre_carrera;
        this.estatus_carrera = estatus_carrera;
