...
public class MantenimientoFacultades extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        List<Facultad> facultad = facultadDAO.select();
        tablaVendedores.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < facultad.size(); i++) {
            dato[0] = facultad.get(i).getCodigo_facultad();
            dato[1] = facultad.get(i).getNombre_facultad();
            dato[2] = facultad.get(i).getEstatus_facultad();
    ...
    public void buscarVendedor() {
        ...
        txtCodigo.setText(facultadAConsultar.getCodigo_facultad());
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        facultadAEliminar.setCodigo_facultad(txtbuscado.getText());
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        facultadAInsertar.setCodigo_facultad(txtCodigo.getText());
...
//        // TODO add your handling code here:
        ...
        facultadAActualizar.setCodigo_facultad(txtbuscado.getText());
